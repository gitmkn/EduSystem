...
<div class="login">
    ...
    <form method="post">
		<input name="phone" type="text" placeholder="请输入用户名" autocomplete="off" required="required"/>
		<hr class="hr15">
		<input name="password" type="password" placeholder="请输入密码" autocomplete="off" required="required" />
		<hr class="hr15">
		<input name="code" type="text" placeholder="请输入验证码" autocomplete="off" required="required" />
		<img src="${ pageContext.request.contextPath }/login/code"/>
		<p id="code"><p>
		<hr class="hr15">
