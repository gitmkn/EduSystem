...
<script type="text/javascript"
	src="${ pageContext.request.contextPath }/assets/js/student.js"></script>
<script type="text/javascript"
	src="${ pageContext.request.contextPath }/assets/js/page.js"></script>
</head>
<body>
	<div class="wrapper">
		...
		<div class="main-panel">
			<div class="content">
				<div class="container-fluid">
					<h4 class="page-title">
						学生管理 <a href="javascript:location.reload();"
							class="badge badge-success" style="float: right;" title="刷新">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<table
										class="table table-head-bg-primary change2 mt-4 table-hover"
										...
										<tbody id="tablepage">
											<c:forEach items="${ userList }" var="user1">
												<tr class="myclass" data-toggle="modal"
													data-target="#update">
									...
									<p class="demo">
									<ul id="barcon" class="pagination pg-primary"
										style="float: left;">
										<!-- <li class="page-item">
											...
											<li class="page-item"><a class="page-link" href="#">总12</a></li>
			...
			<div class="modal-content">
				<div class="modal-header bg-primary">
					<h6 class="modal-title">
						<i class="la la-plus-circle"></i> 学生详细信息修改
					</h6>
					...
					<div class="modal-body">
						...
						<div class="form-group form-inline">
							...
							<label class="form-radio-label"> <input
								...
								class="form-radio-input" type="radio" name="sex" value="女">
						...
						<div class="form-group form-inline">
							...
							<div class="col-md-9 p-0">
								<input type="text" name="address"
									class="form-control input-full" value="元宝区辽东学院">
							</div>
						</div>
						<div class="form-group form-inline">
							<label for="inlineinput" class="col-md-3 col-form-label">学校名</label>
							<div class="col-md-9 p-0">
								<input type="text" name="school" class="form-control input-full"
									value="">
							</div>
						</div>
